/** Hackathon 100-point app quality rubric (matches V2 spec §4). Mirror: control-app/shared/app-rubric.ts */
...
export function rubricFromHuman(rubric: AppRubricScores | null | undefined): AppRubricScores {
